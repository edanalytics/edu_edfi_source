with base_student_iep_service_prescriptions as (
    select * from {{ ref('base_sedm__student_iep_service_prescriptions') }}
),
...
keyed as (
    ...
    from base_student_iep_service_prescriptions
),

deduped as (
    {{ dbt_utils.deduplicate(
        relation='keyed',
        partition_by='k_student_iep_service_prescription',
